...
class wpsm_team_b {
	...
	public function wpsm_team_b_meta_boxes_group(){
		...
		add_meta_box('team_b_donate', __('Donate Us', wpshopmart_team_b_text_domain), array(&$this, 'wpsm_team_b_donate_meta_box_function'), 'team_builder', 'side', 'low');
	...
	public function wpsm_team_b_donate_meta_box_function(){
		?>
			<style>
			#team_b_donate{
			...
			#team_b_donate .hndle , #team_b_donate .handlediv{
			display:none;
			}
			...
			<a href="http://wpshopmart.com/members/signup/YJkidHvYa" target="_blank" >
			<img src="<?php echo wpshopmart_team_b_directory_url.'assets/images/donate-1.jpg'; ?>" style="width:100%;height:auto"/>
			<h3> We Need Your Support</h3>
			<img src="<?php echo wpshopmart_team_b_directory_url.'assets/images/donate-button.png'; ?>" style="width:100%;height:auto"/>
			</a>
			<?php
	}
